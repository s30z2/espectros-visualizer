...
- Body alpha 45% (v47: was 30%), edges/specular opaque
...
5. Chromatic aberration (3-9 px, blend 0.25-0.70)
6. Energy ring on beats > 0.15
7. Beat flash max 25%, threshold 0.4
8. Kick flash max 15%, threshold 0.45
